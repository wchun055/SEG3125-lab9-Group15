      ...
      <main className="flex flex-1 w-full max-w-3xl flex-col items-center justify-between py-32 px-16 bg-white dark:bg-black sm:items-start">
        ...
        <div className="flex flex-col gap-4 text-base font-medium sm:flex-row">
          <form class="max-w-md mx-auto" onSubmit="alert('Your feedback has been submitted!')">
            <label>I would rate my experience a...</label>
            <br></br>
            ...
            <br></br>
            <br></br>
            <label>Which location did you visit?</label>
            <br></br>
            <input required type="text" className="border"/>
            <br></br>
            <br></br>
            <label>Who was your technician?</label>
            <br></br>
            <input required type="text" className="border"/>
            <br></br>
            <br></br>
            ...
            <br></br>
            <textarea className="border" placeholder="My feedback!!"></textarea>
            <br></br>
            <br></br>
